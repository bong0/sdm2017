...
archive_name = 'assignment_submission.zip'
submission_folder = 'assignment_submission'
source_files = []
for task in tasks:
	source_files.extend(task['params']['source_files'])

compressSubmission(source_files, archive_name)
