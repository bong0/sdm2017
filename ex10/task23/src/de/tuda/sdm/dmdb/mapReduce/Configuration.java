 ...
 * Through the configuration the parameters for the job execution are specified
 * @author melhindi
 *
 */
public class Configuration {
	...
	/**
	 * Set the number of reducers used for job execution
	 * Some Executors (e.g., SinglePhaseExecutor) ignore this setting
