...
public abstract class AbstractBitmapIndex<T extends AbstractSQLValue> extends AbstractUniqueIndex<T>{
	...
	protected Map<T, BitSet> bitMaps; // bitmap for each distinc value in the column
	 ...
	 * key column (member variable keyColumnNumner) ) according to a naive bitmap approach.
	 * 
	 */
	...
	public void print() {
		...
		for (T key : this.bitMaps.keySet()) {
			System.out.println("Bitmap of distinc value " + key);
